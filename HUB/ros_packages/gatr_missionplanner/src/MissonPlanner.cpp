...
void MissionPlanner::output_drone_state(){
    // Output the current location of the UAS
    std::cout << std::fixed << std::setprecision(2);
    std::cout << "Current Position: " << drone.state[0] << ", " << drone.state[1] << ", " << drone.state[2] << std::endl;

}

void MissionPlanner::update_drone_state(){
