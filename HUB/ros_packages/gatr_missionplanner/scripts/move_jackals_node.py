...
def spawn_model(model_name, model_xml):
    ...
    pose.position.x = random.uniform(5, 150*0.3048)  # Change this value to set robot's initial x position
    pose.position.y = random.uniform(-5, -150*0.3048)  # Change this value to set robot's initial y position
...
def move_robot(robot_name, speed):
    ...
    state_msg.pose.orientation.x = current_state.orientation.x
    state_msg.pose.orientation.y = current_state.orientation.y
    state_msg.pose.orientation.z = current_state.orientation.z
    state_msg.pose.orientation.w = current_state.orientation.w
