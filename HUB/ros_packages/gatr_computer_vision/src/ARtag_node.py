...
if __name__ == '__main__': # <- Executable 
    ...
    pub_corners_A = rospy.Publisher('AR_corners_A', Int32MultiArray, queue_size=10)     # RGV A
    pub_corners_B = rospy.Publisher('AR_corners_B', Int32MultiArray, queue_size=10)     # RGV B
